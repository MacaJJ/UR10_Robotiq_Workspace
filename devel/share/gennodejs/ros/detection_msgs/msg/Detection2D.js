...
class Detection2D {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('results')) {
        ...
        this.results = new ObjectHypothesisWithPose();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ObjectHypothesisWithPose.serialize(obj.results, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.results = ObjectHypothesisWithPose.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += ObjectHypothesisWithPose.getMessageSize(object.results);
  ...
  static datatype() {
    ...
    return 'detection_msgs/Detection2D';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '3def77e8182e04652c8889aa508f565f';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.results !== undefined) {
      resolved.results = ObjectHypothesisWithPose.Resolve(msg.results)
    }
    else {
      resolved.results = new ObjectHypothesisWithPose()
    }
