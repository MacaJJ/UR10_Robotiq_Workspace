...
class DepthCamera:
	def __init__(self):
		...
		self.color_sub_red = rospy.Subscriber('/myur10/camera1/color/image_raw', Image, self.color_callback)
		...
		self.red_object_pub = rospy.Publisher('/pose/red', Detection2DArray, queue_size=1)

		# Publisher for object pose
		self.blue_object_pub = rospy.Publisher('/pose/blue', Detection2DArray, queue_size=1)
